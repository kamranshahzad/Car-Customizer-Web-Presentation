package com.parts{
	...
	public class Wheels extends MovieClip {
		...
		//public var domain:String="http://www.realtypakistan.net/pro/";
		public var domain:String="http://localhost/addoncars/";
		var remotingGateway:String=domain+"amfphp/gateway.php";
		private var assetPath:String=domain+"assets/parts/effected-imgs/";
		...
		*/
		...
		public function loadPart(pid:Number):void {
			...
			_service.connect(remotingGateway);
		...
		public function get_parts_db(rs:Object) {
			...
			if(rs.serverInfo.initialData[0][11] != '_blank'){		
				...
				loadFrontParts(assetPath + fViewAsset);
			}
			...
			if(rs.serverInfo.initialData[0][12] != '_blank'){		
				...
				loadRearParts(assetPath + rViewAsset);
			}
			...
			if(rs.serverInfo.initialData[0][13] != '_blank'){		
				...
				loadInteriorParts(assetPath + iViewAsset);
			}
			...
			if(rs.serverInfo.initialData[0][14] != '_blank'){		
				...
				loadOtherParts(assetPath + oViewAsset);
			}
			...
			if(rs.serverInfo.initialData[0][15] != '_blank'){		
				...
				loadfViewParts(assetPath + fVIEWAsset);
			}
			...
			if(rs.serverInfo.initialData[0][16] != '_blank'){		
				...
				loadrViewParts(assetPath + rVIEWAsset);
			}
			...
			if(rs.serverInfo.initialData[0][17] != '_blank'){		
				...
				loadiViewParts(assetPath + iVIEWAsset);
			}
